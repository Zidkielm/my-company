            ...
            <div class="overflow-hidden bg-white p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action=" {{ route('admin.hero_sections.update', $hero_section) }} " enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <x-text-input id="heading" class="mt-1 block w-full" type="text" name="heading" value="{{ $hero_section->heading }}" required
                    ...
                    <div class="mt-4">
                        ...
                        <img src=" {{ Storage::url($hero_section->banner) }} " alt="" class="h-[90px] w-[90px] rounded-2xl object-cover">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="subheading" class="mt-1 block w-full" type="text" name="subheading" value="{{ $hero_section->subheading }}"
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="achievement" class="mt-1 block w-full" type="text" name="achievement" value="{{ $hero_section->achievement }}"
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="path_video" class="mt-1 block w-full" type="text" name="path_video" value="{{ $hero_section->path_video }}"
