    ...
    <div class="container relative z-10 mx-auto max-w-[1130px] pt-10">
        ...
        <div id="Hero" class="mt-20 flex flex-col gap-[30px] pb-20">
            ...
            <div class="flex flex-col gap-[10px]">
                <h1 class="max-w-[536px] text-[50px] font-extrabold leading-[65px]">Help Build Biggest <br> Dream
                    From Scratch</h1>
                <p class="text-cp-light-grey max-w-[437px] leading-[30px]">Shayna is an award-winning construction
    ...
    <div class="logo-container flex flex-wrap justify-center gap-5">
        <div
            ...
            <div class="h-9 overflow-hidden">
                <img src="{{ asset('assets/logo/logo-54.svg') }}" class="h-full w-full object-contain"
                    alt="logo">
            </div>
        </div>
        <div
            class="logo-card hover:border-cp-dark-blue flex h-[68px] w-fit shrink-0 items-center gap-[10px] rounded-[18px] border border-[#E8EAF2] bg-white p-4 transition-all duration-300">
            <div class="h-9 overflow-hidden">
                <img src="{{ asset('assets/logo/logo-52.svg') }}" class="h-full w-full object-contain"
                    alt="logo">
            </div>
        </div>
        <div
            class="logo-card hover:border-cp-dark-blue flex h-[68px] w-fit shrink-0 items-center gap-[10px] rounded-[18px] border border-[#E8EAF2] bg-white p-4 transition-all duration-300">
            <div class="h-9 overflow-hidden">
                <img src="{{ asset('assets/logo/logo-55.svg') }}" class="h-full w-full object-contain"
                    alt="logo">
            </div>
        </div>
        <div
            class="logo-card hover:border-cp-dark-blue flex h-[68px] w-fit shrink-0 items-center gap-[10px] rounded-[18px] border border-[#E8EAF2] bg-white p-4 transition-all duration-300">
            <div class="h-9 overflow-hidden">
                <img src="{{ asset('assets/logo/logo-44.svg') }}" class="h-full w-full object-contain"
                    alt="logo">
            </div>
        </div>
        <div
            class="logo-card hover:border-cp-dark-blue flex h-[68px] w-fit shrink-0 items-center gap-[10px] rounded-[18px] border border-[#E8EAF2] bg-white p-4 transition-all duration-300">
            <div class="h-9 overflow-hidden">
                <img src="{{ asset('assets/logo/logo-51.svg') }}" class="h-full w-full object-contain"
                    alt="logo">
            </div>
        </div>
        <div
...
<div id="OurPrinciples" class="container mx-auto mt-20 flex max-w-[1130px] flex-col gap-[30px]">
    ...
    <div class="flex flex-wrap items-center justify-center gap-[30px]">
        <div
            ...
            <div class="flex flex-col gap-5 p-[0_30px_30px_30px]">
                <div class="flex h-[55px] w-[55px] shrink-0 overflow-hidden">
                    <img src="{{ asset('assets/icons/note-favorite.svg') }}" class="h-full w-full object-contain"
                        alt="icon">
                </div>
                <div class="flex flex-col gap-1">
                    <p class="title text-xl font-bold leading-[30px]">Prioritize Trust</p>
                    <p class="text-cp-light-grey leading-[30px]">Shayna is an award-winning ametia construction
        ...
        <div
            ...
            <div class="flex flex-col gap-5 p-[0_30px_30px_30px]">
                <div class="flex h-[55px] w-[55px] shrink-0 overflow-hidden">
                    <img src="{{ asset('assets/icons/user-octagon.svg') }}" class="h-full w-full object-contain"
                        alt="icon">
                </div>
                <div class="flex flex-col gap-1">
                    <p class="title text-xl font-bold leading-[30px]">Professional People</p>
                    <p class="text-cp-light-grey leading-[30px]">Shayna is an award-winning ametia construction
                        company with lorem</p>
                </div>
                <a href="" class="text-cp-dark-blue font-semibold">Learn More</a>
        ...
        <div
            ...
            <div class="flex flex-col gap-5 p-[0_30px_30px_30px]">
                <div class="flex h-[55px] w-[55px] shrink-0 overflow-hidden">
                    <img src="{{ asset('assets/icons/building-4.svg') }}" class="h-full w-full object-contain"
                        alt="icon">
                </div>
                <div class="flex flex-col gap-1">
                    <p class="title text-xl font-bold leading-[30px]">Eco Friendly Concept</p>
                    <p class="text-cp-light-grey leading-[30px]">Shayna is an award-winning ametia construction
                        company with lorem</p>
                </div>
                <a href="" class="text-cp-dark-blue font-semibold">Learn More</a>
    ...
    <div class="container mx-auto max-w-[1000px] py-10">
        <div class="flex flex-wrap items-center justify-between p-[10px]">
            <div class="card flex w-[200px] flex-col items-center gap-[10px] text-center">
                <div class="flex h-[55px] w-[55px] shrink-0 overflow-hidden">
                    <img src="{{ asset('assets/icons/cup.svg') }}" class="h-full w-full object-contain"
                        alt="icon">
                </div>
                <p class="text-cp-pale-orange text-4xl font-bold leading-[54px]">189.409</p>
                <p class="text-cp-light-grey">Award-winning Buildings</p>
            </div>
            <div class="card flex w-[200px] flex-col items-center gap-[10px] text-center">
                <div class="flex h-[55px] w-[55px] shrink-0 overflow-hidden">
                    <img src="{{ asset('assets/icons/buildings.svg') }}" class="h-full w-full object-contain"
                        alt="icon">
                </div>
                <p class="text-cp-pale-orange text-4xl font-bold leading-[54px]">198</p>
                <p class="text-cp-light-grey">HQ Worldwide</p>
            </div>
            <div class="card flex w-[200px] flex-col items-center gap-[10px] text-center">
                <div class="flex h-[55px] w-[55px] shrink-0 overflow-hidden">
                    <img src="{{ asset('assets/icons/status-up.svg') }}" class="h-full w-full object-contain"
                        alt="icon">
                </div>
                <p class="text-cp-pale-orange text-4xl font-bold leading-[54px]">$512bn</p>
                <p class="text-cp-light-grey">Success Investments</p>
            </div>
            <div class="card flex w-[200px] flex-col items-center gap-[10px] text-center">
                <div class="flex h-[55px] w-[55px] shrink-0 overflow-hidden">
                    <img src="{{ asset('assets/icons/star.svg') }}" class="h-full w-full object-contain"
                        alt="icon">
                </div>
                <p class="text-cp-pale-orange text-4xl font-bold leading-[54px]">4.9/5</p>
...
<div id="Products" class="container mx-auto mt-20 flex max-w-[1130px] flex-col gap-20">
    <div class="product flex flex-wrap items-center justify-center gap-[60px] even:flex-row-reverse">
        ...
        <div class="flex h-fit max-w-[500px] flex-col gap-[30px] py-[50px]">
            ...
            <div class="flex flex-col gap-[10px]">
                <h2 class="text-4xl font-bold leading-[45px]">Office Integrated with Biggest Data Server Center
                </h2>
                <p class="text-cp-light-grey leading-[30px]">Lorem ipsum angga’s framework researching amet dolor
    ...
    <div class="product flex flex-wrap items-center justify-center gap-[60px] even:flex-row-reverse">
        ...
        <div class="flex h-fit max-w-[500px] flex-col gap-[30px] py-[50px]">
            <p
                ...
                FAMILY HARMONY</p>
            <div class="flex flex-col gap-[10px]">
                <h2 class="text-4xl font-bold leading-[45px]">Beautiful Theme Park Family and Kids Friendly</h2>
                <p class="text-cp-light-grey leading-[30px]">Lorem ipsum angga’s framework researching amet dolor
                    metrics and perfomance burning rate random says.</p>
            </div>
            <a href=""
    ...
    <div class="product flex flex-wrap items-center justify-center gap-[60px] even:flex-row-reverse">
        ...
        <div class="flex h-fit max-w-[500px] flex-col gap-[30px] py-[50px]">
            ...
            <div class="flex flex-col gap-[10px]">
                <h2 class="text-4xl font-bold leading-[45px]">Public City Center Park with Super Mall & Airport
                </h2>
                <p class="text-cp-light-grey leading-[30px]">Lorem ipsum angga’s framework researching amet dolor
                    metrics and perfomance burning rate random says.</p>
            </div>
...
<div id="Teams" class="mt-20 w-full bg-[#F6F7FA] px-[10px] py-20">
    <div class="container mx-auto flex max-w-[1130px] flex-col items-center gap-[30px]">
        <div class="flex flex-col items-center gap-[14px]">
            <p
                class="badge bg-cp-light-blue w-fit rounded-full p-[8px_16px] text-sm font-bold uppercase text-white">
                OUR POWERFUL TEAM</p>
        ...
        <div
            ...
            <div
                ...
                <div class="flex flex-col gap-1 text-center">
                    <p class="text-xl font-bold leading-[30px]">Angga Setiawan</p>
            ...
            <div
                ...
                <div class="flex flex-col gap-1 text-center">
                    <p class="text-xl font-bold leading-[30px]">Shayna Liza</p>
            ...
            <div
                ...
                <div class="flex flex-col gap-1 text-center">
                    <p class="text-xl font-bold leading-[30px]">Bruno Oleo</p>
            ...
            <div
                ...
                <div class="flex flex-col gap-1 text-center">
                    <p class="text-xl font-bold leading-[30px]">Sami Kimi</p>
            ...
            <div
                ...
                <div class="flex flex-col gap-1 text-center">
                    <p class="text-xl font-bold leading-[30px]">Wibowo Putra</p>
                    <p class="text-cp-light-grey">Senior 3D Designer</p>
                </div>
                <div class="flex items-center justify-center gap-[10px]">
                    <div class="flex h-6 w-6 shrink-0">
            ...
            <div
                ...
                <div class="flex flex-col gap-1 text-center">
                    <p class="text-xl font-bold leading-[30px]">Putri Emily</p>
                    <p class="text-cp-light-grey">Chief Executive Officer</p>
                </div>
                <div class="flex items-center justify-center gap-[10px]">
                    <div class="flex h-6 w-6 shrink-0">
            ...
            <div
                ...
                <div class="flex flex-col gap-1 text-center">
                    <p class="text-xl font-bold leading-[30px]">Yuyan Chin</p>
                    <p class="text-cp-light-grey">Product Manager</p>
                </div>
                <div class="flex items-center justify-center gap-[10px]">
                    <div class="flex h-6 w-6 shrink-0">
            ...
            <div class="testimonial-container flex w-[565px] flex-col gap-[112px]">
                <div class="flex flex-col gap-[30px]">
                    ...
                    <div class="relative pl-[30px] pt-[27px]">
                        ...
                        <p class="relative z-10 text-2xl font-semibold leading-[46px]">Shayna is a leading
                    ...
                    <div class="flex items-center justify-between pl-[30px]">
                        <div class="flex items-center gap-6">
                            ...
                            <div class="flex flex-col justify-center gap-1">
                                ...
                                <p class="text-cp-light-grey text-sm">CRO Kamikapan</p>
                            </div>
                        </div>
            ...
            <div class="testimonial-container flex w-[565px] flex-col gap-[112px]">
                <div class="flex flex-col gap-[30px]">
                    ...
                    <div class="relative pl-[30px] pt-[27px]">
                        ...
                        <p class="relative z-10 text-2xl font-semibold leading-[46px]">Lorem ipsum dolor sit amet
                    ...
                    <div class="flex items-center justify-between pl-[30px]">
                        <div class="flex items-center gap-6">
                            ...
                            <div class="flex flex-col justify-center gap-1">
                                ...
                                <p class="text-cp-light-grey text-sm">Customer Relations</p>
                            </div>
                        </div>
                        <div class="flex flex-nowrap">
                            <div class="flex h-6 w-6 shrink-0">
                    ...
                    <div class="flex items-center justify-between pl-[30px]">
                        <div class="flex items-center gap-6">
                            ...
                            <div class="flex flex-col justify-center gap-1">
                                ...
                                <p class="text-cp-light-grey text-sm">Senior 3D Designer</p>
                            </div>
                        </div>
                        <div class="flex flex-nowrap">
                            <div class="flex h-6 w-6 shrink-0">
                    ...
                    <div class="flex items-center justify-between pl-[30px]">
                        <div class="flex items-center gap-6">
                            ...
                            <div class="flex flex-col justify-center gap-1">
                                ...
                                <p class="text-cp-light-grey text-sm">Product Manager</p>
                            </div>
                        </div>
                        <div class="flex flex-nowrap">
                            <div class="flex h-6 w-6 shrink-0">
                    ...
                    <div class="flex items-center justify-between pl-[30px]">
                        <div class="flex items-center gap-6">
                            ...
                            <div class="flex flex-col justify-center gap-1">
                                ...
                                <p class="text-cp-light-grey text-sm">Chief Executive Officer</p>
                            </div>
                        </div>
                        <div class="flex flex-nowrap">
                            <div class="flex h-6 w-6 shrink-0">
        ...
        <div class="flex flex-wrap gap-[50px]">
            ...
            <div class="flex w-[200px] flex-col gap-3">
                ...
                <a href="" class="text-cp-light-grey transition-all duration-300 hover:text-white">Terms &
                    Conditions</a>
                <a href="contact.html"
                    class="text-cp-light-grey transition-all duration-300 hover:text-white">Contact Us</a>
